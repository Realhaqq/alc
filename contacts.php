<?php 
    ...
    <a href="add_contact.php" class="thin radius button success">Add contact</a>
    </div></div></div>
	</br>
	...
	echo'<table width="100%"><th width="2%" align="left"></td><th width="23%" align="left">Name</th><th width="17%" align="left">Phone</th><th width="22%" align="left">Email</th><th width="36%" align="left">Address</th>';
