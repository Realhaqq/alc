<?php 
	...
	<h5 class="red"><strong>Company</strong></h5>
	<p class="text">';
	if(!empty($row['company'])){echo $row['company'];} else {echo '---';}
	echo'</p>

	<h5 class="red"><strong>Job title</strong></h5>
	<p class="text">';
	if(!empty($row['jobtitle'])){echo $row['jobtitle'];} else {echo '---';}
	echo'</p>


	<h5 class="red"><strong>Website</strong></h5>
	<small><strong> Website should be in this format (http://yahoo.com) only. No www.</strong> </small>
	<p class="text">';
	if(!empty($row['website'])){echo "<a href=".$row['website']." target='_blank'>".$row['website']."</a>";} else {echo '---';}
	echo'</p>
	...
	<h5><strong>Last modified</strong></h5>
	<p class="text">';
